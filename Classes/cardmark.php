    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="cardmark.php">card mark</a></li>
        ...
        <form method="post" class="form-signin">
          ...
          if(!isset($class))
          {
            ...
            <div class="form-group">
              ...
              <?php if(isset($class))
              {?>
                <label>Card Marking For <?php echo $class; ?></label>
                <div class="form-group">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary" name="btn-mark">
                      <i class="glyphicon glyphicon-open-file"></i>&nbsp;Mark card
                    </button>
